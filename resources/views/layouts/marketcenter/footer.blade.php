<div id="footer-wrapper">
        <div id="footer">
            <div id="footer-inner">
					@include('layouts.marketcenter.helpers.footer.standard')

                <div class="footer-bottom">
                    <div class="container">
                        <p class="center no-margin">
                            &copy; 2017ddYour Company, All Right reserved
                        </p>
...
<script type="text/javascript" src="assets/libraries/bootstrap-sass/vendor/assets/javascripts/bootstrap/dropdownafdsfds.js"></script>
