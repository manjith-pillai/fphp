...
<?php get_header($title = 'Properties Rows'); ?>
                            ...
                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="property-row-content col-sm-6 col-md-6 col-lg-8 col-md-6 col-lg-8">
                                                    ...
                                                    <h4 class="property-row-subtitle">
                                                        <a href="#"><?php echo get_location(); ?> , 94108</a>
                                                    </h4><!-- /.property-row-subtitle -->

                                                    <div class="property-row-price"><?php echo get_price(); ?></div><!-- /.property-row-price -->
                                ...
                                <div class="col-sm-3">
                                    <div class="sidebar">
										...
										@include('layouts.marketcenter.helpers.widgets.filter')
