...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('/bower_components/realocation/assets/libraries/font-awesome/css/font-awesome.css') }}" media="screen, projection">
    
	<link rel="stylesheet" type="text/css" href="{{ URL::asset('/bower_components/realocation/assets/libraries/jquery-bxslider/jquery.bxslider.css') }}" media="screen, projection">
    
	<link rel="stylesheet" type="text/css" href="{{ URL::asset('/bower_components/realocation/assets/libraries/flexslider/flexslider.css') }}" media="screen, projection">
    
	<link rel="stylesheet" type="text/css" href="{{ URL::asset('/bower_components/realocation/assets/css/variants/blue.css') }}" media="screen, projection" id="css-main">
    ...
    <title>
       <?php if (!empty($title)): ?><?php echo $title; ?> | <?php endif; ?>RealtyMatrix | Modern Real Estate Solution 
    </title>
</head>
...
<div id="wrapper">
	...
	<!-- include of helpers/headers\standard.php -->
	
	 @include('layouts.marketcenter.helpers.headers.standard')
