...
function loadDoc() {
 ...
 <!-- Main Header -->
  ...
  {{ URL::asset('/css/bootstrap-notifications.min.css') }}">
   ...
   <meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        ...
        <i data-count="0" class="glyphicon glyphicon-bell notification-icon" onclick="loadDoc()">
	    </i>
        </a>
            <ul class="dropdown-menu">
              <li class="header">
...
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/2.1.4/jquery.min.js"></script>
 <script src="//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="
