 <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2016 <a href="#">Foundlay Technologies</a>.</strong> All rights reserved.
  </footer>
...
<script type="text/javascript" src="{{ URL::asset('bower_components/AdminLTE/plugins/jQuery/jquery-2.2.3.min.js') }}"></script>
