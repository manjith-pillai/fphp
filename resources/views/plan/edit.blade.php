...
<?php $page_description = 'Edit Plan' ?>
<?php $level1 = 'Home' ?>
<?php $link = '/plan' ?>
<?php $divide1 = ' -> ' ?>
<?php $level2 = 'Plan Management' ?>
<?php $divide2 = ' -> ' ?>
<?php $level3 = 'Edit Plan' ?>
...
<div class="box box-primary">
    ...
    <!-- /.box-body -->
    <!-- form start -->
    <form class="form-horizontal" action="/admin/plan/{{ $plan->id }}" method="post">
		<div class="box-body">
		...
		<div class="form-group">
			<label  class="col-sm-2 control-label">Display Name <span style="color:red;">*</span> :</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="display_name"   value="{{ $plan->display_name }}">
